class Game{
  ...
  play(){
    form.hide();
    textSize(30);
    text("Game Start", windowWidth/2-130, windowHeight/5)
    ...
    if(allPlayers !== undefined){
      ...
      //var display_position = windowHeight/4;
      for(var plr in allPlayers){
       ...
       if(index === player.index){ 
          ...
          camera.position.x=displayWidth/2; camera.position.y=car[index-1].y 
        ...
        display_position+=20;
        textSize(15);
        text(allPlayers[plr].name + ": " + allPlayers[plr].distance, windowWidth/2 - 80,display_position)*/
